    ...
    import AnimationVideoInfo from "@/components/AnimationVideoInfo.vue";
    import MovieVideoInfo from "@/components/MovieVideoInfo.vue";
    const router =createRouter({
        ...
        routes :[
            ...
            {path : '/videoInfo' , component : AnimationVideoInfo},
            { path: '/movieVideoInfo', component: MovieVideoInfo } // ✅ 추가 완료
